...
- **29 built-in games** — Reflex Tap, Memory Match, Math Blitz, Tic-Tac-Toe Duel, Dino Run, Geometry Jump, Neon Obby (parkour obstacle course), Neon Snake, 2048, Flappy Neon, Neon Pong (online 1v1), Blade Ball (online reflex duel), Fireboy & Watergirl (2-player co-op, level-select map + levers/gates, moving platforms, matching diamonds + saved progress), Brick Breaker, Star Blaster (space shooter), Hoops (basketball), Traffic Racer, Tower Stack, Neon Simon, Sky Tower (Roblox-style vertical obby climb), Cash Clicker (idle simulator with upgrades, saves progress), Neon Slice (blade slicer), Tile Tap (rhythm tiles), Color Dash (endless runner starring your avatar — solo or race an AI), Mole Smash, Neon Blocks (falling-block puzzle), Astro Drift, Disaster Dash (natural-disaster survival), and Road Cross (dodge the traffic). The coin-locked ones (unlock from the Wheel): Color Dash, Mole Smash, Neon Blocks, Astro Drift, Disaster Dash, Road Cross. Your customized avatar stars as the character in the obby/runner games (Neon Obby, Sky Tower, Color Dash).
